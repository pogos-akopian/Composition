...
import com.pogos.myapplication.data.GameRepositoryImpl
import com.pogos.myapplication.domain.entity.GameResult
...
import com.pogos.myapplication.domain.usecases.GenerateQuestionUseCase
import com.pogos.myapplication.domain.usecases.GetGameSettingsUseCase
...
class GameViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun finishGame() {
        _gameResult.value = GameResult(
            ...
            countOfRightAnswers = countOfCorrectAnswers,
